...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 relative overflow-hidden" style={{ background: "hsl(var(--bg))" }}>
      <div className="absolute top-0 right-0 w-96 h-96 rounded-full blur-[150px] opacity-20" style={{ background: "hsl(var(--accent))" }} />
      <div className="absolute bottom-0 left-0 w-80 h-80 rounded-full blur-[150px] opacity-15" style={{ background: "hsl(var(--primary))" }} />
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="w-full max-w-md">
        ...
        >
          ...
          <div>
            <label className="text-xs font-semibold mb-1.5 block" style={{ color: "hsl(var(--text-secondary))" }}>Name</label>
            <div className="relative">
              <User className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4" style={{ color: "hsl(var(--text-muted))" }} />
              <input
          ...
          <div>
            <label className="text-xs font-semibold mb-1.5 block" style={{ color: "hsl(var(--text-secondary))" }}>Email</label>
            <div className="relative">
          ...
          <div>
            <label className="text-xs font-semibold mb-1.5 block" style={{ color: "hsl(var(--text-secondary))" }}>Password</label>
            <div className="relative">
